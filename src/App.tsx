    ...
    <Router>
      <div className="min-h-screen bg-white">
        ...
        <Routes>
          ...
          <Route path="/services/pinterest-organic-growth" element={<PinterestOrganicGrowthPage />} />
          <Route path="/services/pinterest-pin-design" element={<PinterestPinDesignPage />} />
          <Route path="/services/pinterest-ads" element={<PinterestAdsPage />} />
          <Route path="/services/pinterest-seo-ecommerce" element={<PinterestSeoEcommercePage />} />
